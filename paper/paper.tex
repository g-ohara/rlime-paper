...
% I want to arrange figures in the following order:
% (a) Instances around the focal point.
% (b) Explanations by LIME.
% (c) Explanations by Anchor.
% (d) Explanations by R-LIME.
% but I want to put both (b) and (c) vertically in left column
% and (d) in right column.
