...
{%
  ...
  We would like to appriciate all the reviewers for their very helpful comments.
  We added an overview of other existing methods, discussion about parameter
  selection, and comparisons between Anchor and R-LIME\@.
  Below are suggestions from reviewers and our response.
  ...
  \begin{enumerate}
    ...
    \item Offer guidance on how to select optimal parameters for different
          ...
          \begin{mycomment}
            Thank you for your suggestion. We added guidance on how parameters
            should be selected in practical use cases to \cref{sec:discussion}.
          \end{mycomment}
    ...
    \item Include a discussion of other model-agnostic interpretability methods,
          ...
          \begin{mycomment}
            ...
            model-agnostic interpretability methods to \cref{sec:related-work}.
          \end{mycomment}
    ...
    \item Add experimental comparisons with more other model-agnostic \\
          ...
          \begin{mycomment}
            Thank you for your suggestion. We additionally conducted qualitative
            and quantitative comparisons between Anchor and R-LIME,
            which demonstrated that R-LIME is more effective than Anchor.
          \end{mycomment}
  \end{enumerate}
  ...
  \begin{itemize}
    ...
    \item The authors should consider exploring a more compatible method than the
          ...
          \begin{mycomment}
            ...
            It is true that there are theoretical issues for using the KL-LUCB
            algorithm, although our results suggest that its practical effect
            is negligible.
            We leave the issues to the future work because of our limited time.
          \end{mycomment}
  ...
  {%
    ...
    {%
      ...
      \newcommand{\limesubfigure}[2]{
        \begin{subfigure}[t]{\textwidth}
          \hspace{#2}
          \includegraphics[scale=\scale]{exp1/ver1/examples/output/lime-\index{#1}}
      ...
      \newcommand{\anchorsubfigure}[1]{
        \foreach{\a} in {70,80,90}{
            \begin{subfigure}[t]{\textwidth}
              \centering
              \includegraphics[scale=0.33]{exp1/ver2/examples/anchor-\index{#1}-\a}
      ...
      \newcommand{\rlimesubfigure}[3]{
        \begin{subfigure}[t]{\textwidth}
          \hspacebase{}
          \hspace{#3}
          \includegraphics[scale=\scale]{exp1/ver1/examples/output/newlime-\index{#1}-#2}
          \vspacebeforecaption{}
          \caption{R-LIME ($\tau=0.#2$)}\label{fig:rlime-#1-#2}
          \vspacebase{}
        \end{subfigure}
      }
      \begin{figure}[t]
        \begin{subfigure}[t]{0.45\textwidth}
          \centering
          \limesubfigure{0}{-10pt}
          \anchorsubfigure{0}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.45\textwidth}
          \rlimesubfigure{0}{70}{-10pt}

          \vspace{12pt}
          \rlimesubfigure{0}{90}{-22pt}
        \end{subfigure}
      ...
      \begin{figure}[t]
        \begin{subfigure}[t]{0.45\textwidth}
          \limesubfigure{1}{-30pt}
          \anchorsubfigure{1}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.45\textwidth}
          \rlimesubfigure{1}{70}{-10pt}

          \vspace{18pt}
          \rlimesubfigure{1}{90}{-25pt}
        \end{subfigure}
...
\subsection{\hl{Quantitative Evaluation: Anchor vs. R-LIME}}
...
\hl{
  ...
  under the values of $\tau=0.70,0.80,0.90$.
}
...
\section{\hl{Discussion}}\label{sec:discussion}
{%
