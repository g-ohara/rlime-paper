...
\graphicspath{{./src/img}{./src/experiments/exp1/ver1/examples/output}{./src/experiments/exp2}}
    ...
    {%
      ...
      \begin{figure}[p]
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{1.0em}
          \includegraphics[scale=\scale]{lime-\Asample}
          \vspacebeforecaption{}
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{0.5em}
          \includegraphics[scale=\scale]{newlime-\Asample-70}
          \vspacebeforecaption{}
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \includegraphics[scale=\scale]{newlime-\Asample-80}
          \vspacebeforecaption{}
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{-0.5em}
          \includegraphics[scale=\scale]{newlime-\Asample-90}
          \vspacebeforecaption{}
      ...
      \begin{figure}[p]
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{-0.7em}
          \includegraphics[scale=\scale]{lime-\Bsample}
          \vspacebeforecaption{}
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{0.5em}
          \includegraphics[scale=\scale]{newlime-\Bsample-70}
          \vspacebeforecaption{}
        ...
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{-0.8em}
          \includegraphics[scale=\scale]{newlime-\Bsample-80}
          \vspacebeforecaption{}
          \caption{R-LIME ($\tau=0.80$)}
        \end{subfigure}
        \begin{subfigure}[t]{\imgwidth}
          \hspacebase{}
          \hspace{-0.8em}
          \includegraphics[scale=\scale]{newlime-\Bsample-90}
          \vspacebeforecaption{}
      ...
      \end{figure}
      \newcommand{\anchorsubfigure}[2]{
        \def\dir{src/experiments/exp1/ver2/examples}
        \begin{subfigure}[t]{\imgwidth}
          \centering
          \includegraphics[scale=\scale]{\dir/anchor-#1-#2}
          \vspacebeforecaption{}
          \caption{$\tau=0.#2$}
          \vspacebase{}
        \end{subfigure}
      ...
      \begin{figure}[tbp]
        \centering
        \foreach{\tauloop}in{70,80,90}{\anchorsubfigure{\Asample}{\tauloop}}
        \caption{Explanation for Instance A by Anchor.}
      \end{figure}
      \begin{figure}[tbp]
        \centering
        \foreach{\tauloop}in{70,80,90}{\anchorsubfigure{\Bsample}{\tauloop}}
        \caption{Explanation for Instance B by Anchor.}
      \end{figure}
    }
  }
